...
import ChatInput from '@/components/server/ChatInput.vue'
import Messages from '@/components/server/Messages.vue'
</script>

<template>
	<div class="grow flex flex-col h-screen">
		<div>
			<div class="p-3 shadow-md font-black flex">
				<div class="p-1">
					<svg
