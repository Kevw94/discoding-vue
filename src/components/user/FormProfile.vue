<template>
	<form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 w-10/12">
		...
		<div class="mb-4">
			<label class="block text-gray-700 text-sm font-bold mb-2" for="username"> Bio </label>
			<textarea
				v-model="form.bio"
				id="message"
				rows="4"
				class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 resize-none rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500"
		...
		<div class="mb-4">
			...
			<input
				...
				id="username"
				type="text"
				placeholder="http://My-Profile-Picture"
			/>
		</div>
