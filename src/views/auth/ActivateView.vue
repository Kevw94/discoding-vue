<template>
    <div class="activation-container flex w-screen h-screen items-center justify-center bg-gray-900">
      <div class="bg-gray-800 p-8 rounded-lg shadow-md max-w-xs w-full text-center">
        ...
        />
        <button @click="activateAccount" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
          Activate
        </button>
