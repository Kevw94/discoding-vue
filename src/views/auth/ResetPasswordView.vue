<template>
  <div class="password-reset-container flex w-screen h-screen items-center justify-center bg-gray-900">
    <form @submit.prevent="submitResetPassword" class="bg-gray-800 p-8 rounded-lg shadow-md w-full max-w-xs">
